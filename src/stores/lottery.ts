...
export const windowLevelList: WindowLevelEnumItem[] = [
  ...
  { key: 'RED_TAIL_3', label: '红尾3窗口', category: 'RED_TAIL' },
  { key: 'RED_TAIL_4', label: '红尾4窗口', category: 'RED_TAIL' },
  { key: 'RED_TAIL_5', label: '红尾5窗口', category: 'RED_TAIL' },
  { key: 'RED_TAIL_6', label: '红尾6窗口', category: 'RED_TAIL' },
  { key: 'RED_TAIL_8', label: '红尾8窗口', category: 'RED_TAIL' },
